...
- [Vidorey Monitor](vidorey-monitor.md) — ring buffer 50k + virtual list; SSE Koyeb fix; Histats sekarang site-wide (9 halaman publik, bukan cuma /monitor), tracking jalan meski widget counter cuma tampil di domain terdaftar.
...
- [Vidorey Ad Optimization](vidorey-ad-optimization.md) — ads.js + sticky banner; script jaringan menangani popunder; directlink memakai zone turbulentrefreshments; zone conflict rule.
