...
- `lib/scrapers/{p1,rb,yb,bk,tp}.js` — one file per platform, each exports `{ router, caches }`; no cross-imports between platform files.
- `server.js` is now a thin composition root (~150–200 lines, 5 platforms).
