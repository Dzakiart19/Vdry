...
function trackRequest(req, _res, next) {
  ...
  else if (p.startsWith('/proxy/rb/hls/'))    pushMonitorEvent('rb_stream', { id: p.split('/')[4] || '?', ip, ua });
  ...
  else if (p.startsWith('/proxy/yb/hls/'))    pushMonitorEvent('yb_stream', { id: p.split('/')[4] || '?', ip, ua });
  ...
  else if (p.startsWith('/proxy/bk/stream/')) pushMonitorEvent('bk_stream', { id: p.split('/')[4] || '?', ip, ua });
  ...
  else if (p.startsWith('/proxy/tp/hls/'))    pushMonitorEvent('tp_stream', { id: p.split('/')[4] || '?', ip, ua });
  ...
  else if (p.startsWith('/proxy/sb/hls/'))    pushMonitorEvent('sb_stream', { id: p.split('/')[4] || '?', ip, ua });
  ...
  else if (p.startsWith('/proxy/xn/hls/'))    pushMonitorEvent('xn_stream', { id: p.split('/')[4] || '?', ip, ua });
  ...
  else if (p.startsWith('/proxy/vd/stream/')) pushMonitorEvent('vd_stream', { id: p.split('/')[4] || '?', ip, ua });
  ...
  else if (p.startsWith('/proxy/zg/stream/')) pushMonitorEvent('zg_stream', { id: p.split('/')[4] || '?', ip, ua });
  else if (p.startsWith('/api/er/video/'))    pushMonitorEvent('er_video',  { id: p.split('/')[4] || '?', ip, ua });
  else if (p.startsWith('/api/er/posts'))     pushMonitorEvent('er_posts',  { ip, ua });
  else if (p.startsWith('/proxy/er/stream/')) pushMonitorEvent('er_stream', { id: p.split('/')[4] || '?', ip, ua });
  next();
}
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .b-er_video{background:#1a0f0a;color:#fda4af}
  .b-er_posts{background:#1a0f0a;color:#fecdd3}
  .b-er_stream{background:#1a0f0a;color:#ff8fa3}
  .b-rb_stream{background:#3b1d5a;color:#e879f9}
  .b-yb_stream{background:#14532d;color:#86efac}
  .b-bk_stream{background:#1c2a3a;color:#7dd3fc}
  .b-tp_stream{background:#3a0a1a;color:#fb7185}
  .b-sb_stream{background:#0a2e18;color:#6ee7b7}
  .b-xn_stream{background:#3a1c0a;color:#fdba74}
  .b-vd_stream{background:#0a1e3a;color:#93c5fd}
  .b-zg_stream{background:#2d0a1e;color:#f9a8d4}
...
<div id="histats_wrap" style="flex-shrink:0;display:flex;align-items:center;gap:12px;padding:6px 12px 8px;min-height:44px;border-bottom:1px solid #1f1f2e">
  ...
  <a href="https://www.histats.com/viewstats/?sid=5040431&act=2" target="_blank" rel="noopener"
