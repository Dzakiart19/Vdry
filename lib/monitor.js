...
<div id="histats_wrap" style="flex-shrink:0;display:flex;align-items:center;gap:10px;padding:6px 0 8px;min-height:44px;border-bottom:1px solid #1f1f2e">
  <!-- Counter widget — static img (selalu muncul tanpa JS) -->
  <a href="https://www.histats.com" target="_blank" rel="noopener" title="Visitor Counter" style="display:flex;align-items:center;text-decoration:none">
    <img src="https://sstatic1.histats.com/0.gif?5040431&101" alt="Histats Counter" border="0" style="display:block;min-height:31px;min-width:70px;">
  </a>
  <!-- JS-rendered counter (akan di-inject oleh Histats script) -->
  <div id="histats_counter" style="display:inline-block;min-width:80px;min-height:31px;"></div>
  <span style="font-size:11px;color:#5a5a72;">Visitor Counter</span>
</div>
<div id="scroll-wrap">
  <div id="vlist"></div>
